...
output: 
  flexdashboard::flex_dashboard:
    source_code: "https://github.com/ottlngr/2016-15/blob/ottlngr/ottlngr/waste_ottlngr_flexdashboard.Rmd"
    theme: journal
    orientation: columns
...
sites$campus <- ifelse(grepl("University", sites$site.name) | grepl("University", pattern = sites$street_address) | grepl("Campus", sites$street_address), 1, 0)
